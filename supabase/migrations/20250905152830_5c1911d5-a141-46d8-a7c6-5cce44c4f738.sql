...
-- Drop ALL existing policies for contractors table
...
DROP POLICY IF EXISTS "admins_manage_contractors" ON public.contractors;
DROP POLICY IF EXISTS "contractors_read_self" ON public.contractors;
